...
EXPECTED_ENGLISH = {
    ...
    # Cycle 3 additions
    "daily", "weekly", "monthly", "yearly", "quarter", "quarterly",
    "level", "levels", "automatic", "automation",
    "accountant", "admission", "applicable", "branding", "book",
    "build", "challenging", "chatgpt", "claude", "anthropic",
    "closing", "college", "combination", "count", "critical",
    "custom", "decide", "deliver", "designer", "district", "dental",
    "education", "embroidered", "engineering", "entries", "exercise",
    "expectation", "family", "fees", "file", "filing", "focus",
    "formal", "friends", "gold", "silver", "diamond",
    "hoodies", "hoodie", "honestly", "honest", "human",
    "iit", "iim", "imo", "fyi", "fcfs",
    "impressed", "included", "include", "income", "item",
    "itr", "tds", "irs",
    "job", "jobs", "loan", "lunch", "dinner", "breakfast",
    "management", "manager", "mouth", "movie", "music",
    "notification", "notify", "offer", "offers",
    "office", "papa", "mama", "parents",
    "personal", "professional", "private",
    "proprietorship", "partnership", "llp",
    "quote", "quotes", "reminder", "reorder", "replace",
    "reply", "resign", "revisions", "routine",
    "sake", "salary", "sbi", "hdfc", "icici", "axis", "kotak",
    "scheme", "script", "season", "set", "simple",
    "software", "sole", "stock-take", "stockout", "sweatshirts",
    "system", "try", "use", "usually", "wear",
    "word", "work", "ai", "ml", "data",
    "bombay", "calcutta", "madras",
    "sherwani", "kurta", "saree", "lehenga",
    "pajama", "kurta-pajama", "casual",
    "chatgpt", "gemini", "perplexity", "openai", "google",
    "iphone", "android", "samsung",
    # Cycle 4 additions — pure English in domain
    "base", "clear", "control", "damage", "platform", "queries", "sale",
    "star", "accounts", "ad", "ads", "app", "apps", "attempts",
    "auto-reply", "automated", "behavior", "board", "ca", "com",
    "commission", "comparison", "complaint", "condition", "content",
    "edited", "festival", "finance", "insights", "intact", "learning",
    "math", "models", "outfits", "penalties", "penalty", "perform",
    "photo", "photographer", "photoshoot", "policy", "process",
    "quick", "reality", "reels", "replacement", "satisfaction",
    "school", "slot", "static", "story", "studio", "taxation",
    "amazon", "flipkart", "meesho", "myntra", "ajio", "snapdeal",
    "ebay", "alibaba", "shopify", "etsy",
    ...
    "ggsm", "kiosk",
    # Full-script QA additions — pure English from Claude-generated scripts
    "same", "perfect", "range", "actually", "compared", "fiber", "fibers",
    "import", "imports", "market", "markets", "tshirts", "tees",
    "automatically", "naturally", "specifically", "specially", "especially",
    "bold", "breathable", "chest", "compromise", "curl", "details",
    "factories", "fitted", "flow", "medium", "proper", "ratio", "recommend",
    "rough", "seamless", "soft", "solid", "surface", "thick", "thin",
    "through", "tier", "transparent", "trendy", "uneven", "weaving",
    "adidas", "nike", "puma", "reebok",
    "alignment", "almost", "already", "america", "europe",
    "area", "arm", "available", "back", "bags", "balance", "barely",
    "basic", "because", "blur", "bone", "boxes", "bright", "category",
    "cities", "city", "class", "classic", "clean", "cleaning", "coarse",
    "comfortable", "conscious", "consider", "consistent", "consumption",
    "continuous", "cotton-polyester", "decent", "decision", "definitely",
    "deliberately", "edge", "edges", "element", "end", "even", "every",
    "exact", "exactly", "expect", "expected", "experiment", "explain",
    "fabrics", "factor", "finish", "first", "friendly", "front",
    "halftones", "higher", "hue", "improve", "intentional",
    "international", "invest", "labour", "labor", "layer", "least",
    "lengthwise", "light", "lightweight", "lines", "long", "loop",
    "maintain", "manufacture", "manufacturer", "manufacturers",
    "mass", "maybe", "minimum", "mixed", "mostly", "nature", "navy",
    "normally", "option", "original", "part", "parts", "perfectly",
    "phenomenon", "photographic", "placement", "planning", "poly",
    "portions", "position", "post-wash", "prints", "priority", "pure",
    "quantity", "re-order", "refined", "relaxed", "requirement",
    "sell-through", "sense", "show", "sign", "silhouette", "slow",
    "specialty", "specific", "specify", "square", "stable", "strong",
    "structure", "sturdy", "superior", "surprised", "tension",
    "textured", "thickness", "threads", "uncomfortable", "underbase",
    "unique", "usp", "warp", "washes", "wastage", "way", "winner",
    "wobbly", "wrap", "wrong", "fasta",  # likely typos / English
    # Full-script QA round 2
    "dye", "dyes", "dyed", "heavy", "multiply", "multiplied",
    "audience", "complain", "complaints", "confidence", "depend",
    "different", "digital", "easily", "experience", "fading", "fade",
    "guaranteed", "guys", "idea", "merchandise", "tops", "transparency",
    "absorption", "ac", "accurate", "boss", "cafes", "cafe",
    "carefully", "centimeter", "cheaper", "coating", "complete",
    "composition", "computerized", "confusion", "construction",
    "cotton-poly", "poly-cotton", "deep", "density", "dive", "drape",
    "dull", "duty", "each", "economical", "elasticity", "example",
    "expensive", "fitness", "fitting", "fixing", "fold", "hard",
    "high-end", "holes", "influencer", "influencers", "inks",
    "insist", "just", "language", "league", "lifestyle", "low",
    "match", "measurement", "most", "move", "neon", "offices",
    "out", "outdoor", "pastels", "pink", "postpone", "prove",
    "reactive", "retention", "scissors", "screens", "segment",
    "seriously", "shops", "smoothness", "sold", "suppose", "summers",
    "target", "that's", "then", "trick", "type", "uniform", "upgrade",
    "validate", "vary", "vendor", "ventilation", "was", "waters",
    "weak", "workers", "xl", "xs", "xxl", "xxxl", "zero", "bhatak-ta",
    # Round 3 English additions
    "suggest", "tune", "add", "approve", "approval", "bleeding", "bleed",
    "depending", "flag", "problems", "pull", "references", "reference",
    "safe", "stickers", "without", "accordingly", "any", "approach",
    "assume", "basis", "beginners", "beginner", "bend", "bet",
    "blindly", "bonding", "boutique", "buyers", "buyer", "chat",
    "checking", "chemical", "chemicals", "colleges", "comfort",
    "competitor", "competitors", "compress", "confused", "convince",
    "corporates", "cover", "creative", "curing", "degree", "degrees",
    "delay", "deposit", "desperate", "disaster", "distort",
    "eco-conscious", "eco-friendly", "faded", "farming", "force",
    "generally", "genuine", "grip", "guarantee", "halftone", "handle",
    "humid", "idle", "intricate", "investigation", "issues",
    "limited", "lower", "many", "maximum", "mindset", "misprints",
    "moisture", "moment", "moving", "multiple", "notice", "output",
    "past", "peak", "positioning", "press", "puckering",
    "reasonable", "registration", "risk", "select", "shading",
    "shape", "shirts", "skip", "smart", "solution", "stability",
    "success", "suits", "technically", "temperature", "terms",
    "testing", "text", "treatment", "underestimate", "verified",
    "verify", "vibrancy", "vintage", "waive",
    # Round 4 English
    "grade", "grades", "polos", "durable", "evening", "finally",
    "oxidation", "pigment", "pigments", "shades", "shade",
    "adhesion", "adjust", "air", "athleisure", "body", "bond",
    "bonus", "breathability", "buttons", "care", "casuals", "chalk",
    "circulation", "clearly", "controlled", "creamy", "crowd",
    "detergent", "during", "educate", "enzymes", "fest", "flat",
    "fresh", "handling", "image", "iron", "labeling", "life",
    "lint", "lose", "manufacturing", "material", "materials",
    "matsui", "means", "packing", "pay", "peel", "penetrate",
    "people", "permanently", "physical", "place", "pressure",
    "pretreatment", "printed", "property", "pucker", "register",
    "regularly", "relax", "retain", "returned", "rubber", "safety",
    "selection", "slight", "slightly", "solve", "spray", "stains",
    "steam", "stiff", "stretching", "stuck", "temporary", "thumb",
